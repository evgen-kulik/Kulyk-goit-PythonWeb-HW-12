...
======================================================================================================================
Домашнє завдання модулю №14.
1. За допомогою "Sphinx" створено документацію. Для цього плагіном "Trelent - AI Docstrings on Demand" (команда Alt+d) додано "docstrings".
2. Додано модульні тести для модулів репозиторію на базі фреймворку "Unittest".
3. Покрито функціональними тестами маршрут "api/auth" за допомогою фреймворку "Pytest".